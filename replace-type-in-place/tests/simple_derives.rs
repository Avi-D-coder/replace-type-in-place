...
fn test_replace_in_place_enum() {
    ...
    let replaced1 = original1.replace_in_place(&mut |x| x * 2);
    let replaced2 = original2.replace_in_place(&mut |x| x * 2);
    let replaced3 = original3.replace_in_place(&mut |x: i32| x * 2);
...
fn test_replace_in_place_size_check() {
    ...
    let _replaced = original.replace_in_place(&mut |x| x as i64);
}
...
fn test_replace_in_place_alignment_check() {
    ...
    let _replaced = original.replace_in_place(&mut |Aligned(x)| x);
}
